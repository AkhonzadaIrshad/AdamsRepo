...
- (nonnull instancetype)initWithCardNumber:(NSString * _Nonnull)cardNumber cardExpiryMonth:(NSString * _Nonnull)cardExpiryMonth cardExpiryYear:(NSString * _Nonnull)cardExpiryYear cardSecurityCode:(NSString * _Nonnull)cardSecurityCode saveToken:(BOOL)saveToken OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCardNumber:(NSString * _Nonnull)cardNumber cardExpiryMonth:(NSString * _Nonnull)cardExpiryMonth cardExpiryYear:(NSString * _Nonnull)cardExpiryYear cardSecurityCode:(NSString * _Nonnull)cardSecurityCode OBJC_DESIGNATED_INITIALIZER;
...
+ (NSString * _Nonnull)rawValueWithEnumValue:(enum MFMobileCountryCodeISO)enumValue SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithInvoiceValue:(double)invoiceValue paymentMethod:(NSInteger)paymentMethod callBackUrl:(NSString * _Nonnull)callBackUrl errorUrl:(NSString * _Nonnull)errorUrl OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithInvoiceValue:(double)invoiceValue paymentMethod:(NSInteger)paymentMethod OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithInvoiceAmount:(double)invoiceAmount currencyIso:(enum MFCurrencyISO)currencyIso OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) double unitPrice;
@end

typedef SWIFT_ENUM(NSInteger, MFInvoiceOption, open) {
...
@property (nonatomic, copy) NSString * _Nonnull userDefinedField;
@property (nonatomic) NSInteger supplierCode;
- (nonnull instancetype)initWithInvoiceValue:(double)invoiceValue notificationOption:(enum MFNotificationOption)notificationOption customerName:(NSString * _Nonnull)customerName OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
