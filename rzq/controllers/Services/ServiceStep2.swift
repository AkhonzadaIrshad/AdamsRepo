...
//        marker.map = gMap
    ...
    func goToStep3() {
        if let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ServiceStep3") as? ServiceStep3
        {
...
extension ServiceStep2 : GMSMapViewDelegate {
...
extension ServiceStep2: GMSAutocompleteViewControllerDelegate {
...
extension ServiceStep2: UITextFieldDelegate {
