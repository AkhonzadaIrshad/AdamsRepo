...
class TenderStep3: BaseVC, UINavigationControllerDelegate, ImagePickerDelegate {
...
extension TenderStep3 : GMSMapViewDelegate {
...
extension TenderStep3: UIImagePickerControllerDelegate {
